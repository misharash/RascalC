...
def Psi(alpha: float, c2: np.typing.NDArray[np.float64], c3: np.typing.NDArray[np.float64], c4: np.typing.NDArray[np.float64], c2s: np.typing.NDArray[np.float64], c3s: np.typing.NDArray[np.float64], c4s: np.typing.NDArray[np.float64]) -> np.typing.NDArray[np.float64]:
...
def neg_log_L1(alpha: float, target_cov: np.typing.NDArray[np.float64], c2: np.typing.NDArray[np.float64], c3: np.typing.NDArray[np.float64], c4: np.typing.NDArray[np.float64], c2s: np.typing.NDArray[np.float64], c3s: np.typing.NDArray[np.float64], c4s: np.typing.NDArray[np.float64]) -> float:
...
def fit_shot_noise_rescaling(target_cov: np.typing.NDArray[np.float64], c2: np.typing.NDArray[np.float64], c3: np.typing.NDArray[np.float64], c4: np.typing.NDArray[np.float64], c2s: np.typing.NDArray[np.float64], c3s: np.typing.NDArray[np.float64], c4s: np.typing.NDArray[np.float64]) -> float:
...
def load_matrices_multi(input_data: dict[str], cov_filter: np.ndarray[int], full: bool = True, jack: bool = False, ntracers: int = 2) -> tuple[np.typing.NDArray[np.float64], np.typing.NDArray[np.float64], np.typing.NDArray[np.float64]]:
