...
public:
	...
	char *corname = NULL;
	const char default_corname[500] = "xi/xi_n100_m120_11.dat";
    ...
    const char default_RR_bin_file[500] = "weights/binned_pair_counts_n16_m12_j20_11.dat";

    //---------- JACKKNIFE PARAMETERS ---------------------------------------

    // Name of the jackknife weight file
    char *jk_weight_file = NULL; // w_{aA}^{11} weights
    const char default_jk_weight_file[500] = "weights/jackknife_weights_n16_m12_j20_11.dat";
