...
for t in range(len(tlabels)):
    # read with redshift cut, both data and randoms
...
results = run_cov(mode = mode, max_l = max_l, boxsize = periodic_boxsize,
                  ...
                  randoms_positions1 = randoms_positions[0], randoms_weights1 = randoms_weights[0], randoms_samples1 = randoms_weights[0],
                  randoms_positions2 = randoms_positions[1], randoms_weights2 = randoms_weights[1], randoms_samples2 = randoms_weights[1],
