...
if do_counts or cat_randoms:
    cat_randoms_file = "LRG_z0.800_cutsky_seed3_S100-1000_random.xyzwj"
# CF options
convert_cf = 1
if convert_cf:
    pycorr_filenames = [check_path("/global/cfs/projectdirs/desi/users/dvalcin/EZMOCKS/LRG/Xi/xi_ez_LRG_cutsky_seed3_z0.4_1.1.npy")]
...
if jackknife:
    data_ref_filename = check_path("/global/cfs/projectdirs/desi/users/dvalcin/EZMOCKS/LRG/Mocks/LRG_z0.800_cutsky_seed3_data.fits") # for jackknife reference only, has to have rdz contents
...
outdir = "out_seed3" # output file directory
