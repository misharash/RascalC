...
mbin = 60 # angular (mu) bins for output cov (except in Legendre case, where this is for correction function fit only)
...
if legendre:
    phi_name = os.path.join(tmpdir, f"BinCorrectionFactor_n{nbin}_" + ("periodic" if periodic else f'm{mbin}') + "_11.txt")
